...
public class CustomTabLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.custom_tab_layout, this, true);
    ...
    public static class ViewPagerOnTabSelectedListener implements TabLayout.OnTabSelectedListener {
        ...
        public ViewPagerOnTabSelectedListener(ViewPager viewPager, CustomTabLayout enhanceTabLayout) {
            mViewPager = viewPager;
            mTabLayoutRef = new WeakReference<CustomTabLayout>(enhanceTabLayout);
        }
